        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 ">
            ...
            <div class="p-3 mb-2 bg-info text-white">
              <ul>
                <li>
                  <h2>Tổng tiền hàng: <?php echo number_format($sum_all); ?>đ</h2>
                </li>
                <li>
                  <h2>Giảm giá: -<?php echo $giam; ?>đ</h2>
                </li>
                <li>
                  <h2>Phí ship: +<?php echo $ship; ?>đ</h2>
                </li>
                <li>
                  <h2 style="font-weight: bold;">Thành tiền: <?php echo $sum_alls; ?>đ</h2>
                </li>
              </ul>
            </div>
