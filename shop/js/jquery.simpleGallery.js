  ...
  $.fn.simpleGallery = function (options) {
    ...
    var init = function () {
      ...
      var image_container = $(this)
        .parents(opts.gallery_container)
        .find(opts.big_image_container);

      var loading_image = $("<img>", { src: opts.loading_image });
      image_container.html(loading_image);

      var a = $("<a>")
        .attr("data-lens-image", lens_image)
        .addClass(opts.parent_anchor_class);
      var img = $("<img>")
        .load(function () {
          img.appendTo(a);
