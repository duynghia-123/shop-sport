          ...
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <div class="aa-recently-views">
                <ul>
                  <li>
                    <a href="product-detail1.html" class="aa-cartbox-img" style="height: 112px;"><img alt="img" src="img/products/serrishop48235quần nike.jpg"></a>
                    <div class="aa-cartbox-info">
                      <h4><a href="product-detail1.html">Quần Nike dài form ôm</a></h4>
                      <p>295,000₫</p>
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="aa-cartbox-info">
                      <h4><a href="product-detail2.html">Quần dài lưng thun kẻ sọc</a></h4>
                      <p>298.000₫</p>
                    </div>
                  </li>
                </ul>
