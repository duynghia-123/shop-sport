          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-server"></i>Hoạt động<span class="fa fa-chevron-down" aria-hidden="true"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="index.php">Hoạt động gần đây</a></li>
                  </ul>
                </li>
      ...
      <div class="right_col" role="main">
        ...
        <footer>
          <div class="pull-right">
            Duy Nghĩa <a href="https://colorlib.com">VKU</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
