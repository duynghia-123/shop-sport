            ...
            <div class="aa-product-area">
              <div class="aa-product-inner">
                ...
                <ul class="nav nav-tabs aa-products-tab">
                  ...
                  <li><a href="#women" data-toggle="tab">QUẦN</a></li>
                </ul>
                <!-- Tab panes -->
                      ...
                      while ($new_items = mysqli_fetch_array($new_res)) { ?>
                        <li>
                          <figure>
                            ...
                            <?php endif ?>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="product-detail.php?id=<?php echo $new_items['id']; ?>"><?php echo $new_items['name']; ?></a>
                              </h4>
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4">
                <div class="aa-latest-blog-single">
                  ...
                  <div class="aa-blog-info">
                    <h3 class="aa-blog-title"><a href="#">Kyrgios muốn giải nghệ sớm sau thảm bại ở Laver Cup</a></h3>
                    <p>Tôi cảm thấy bản thân không còn gì để chứng tỏ nữa. Tôi tự hào với những gì làm được trong sự
                      nghiệp. Việc góp mặt ở Laver Cup là phần thưởng. Tôi luôn cố gắng khi vào sân và đánh giá cao tình
                      đồng đội của Laver Cup. Nhưng tôi không phải mẫu tay vợt sẽ thi đấu bền bỉ. Tôi sẽ treo vợt sớm
                      trong hai, ba năm tới.</p>
              ...
              <div class="col-md-4 col-sm-4">
                <div class="aa-latest-blog-single">
                  ...
                  <div class="aa-blog-info">
                    <h3 class="aa-blog-title"><a href="#">Kết quả cầu lông bán kết Sudirman Cup: Lee Zii Jia ngông cuồng
                        khiêu khích và hạ Momota!</a></h3>
                    <p>Có lẽ do từng thua Momota ở vòng bảng Sudirman Cup 2021 nên Lee Zii Jia bị khớp, để cho số 1 thế
                      giới người Nhật nhanh chóng tạo cách biệt ở đầu game 1. Nhưng sau đó, tận dụng Momota đáng không
                      chắc tay, ĐKVĐ SEA Games vùng lên và bất ngờ thắng ngược 22-20.</p>
                    <a href="#" class="aa-read-mor-btn">Đọc thêm <span class="fa fa-long-arrow-right"></span></a>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-4">
                <div class="aa-latest-blog-single">
                  ...
                  <div class="aa-blog-info">
                    <h3 class="aa-blog-title"><a href="#">Trần Thị Thanh Thúy chính thức đầu quân cho CLB PFU Bluecats
                        Nhật Bản</a></h3>
                    <p>Ngày hôm qua, từ sáng sớm Thanh Thúy đã di chuyển thẳng từ Long An lên sân bay Tân Sơn Nhất,
                      trước khi chính thức có mặt tại Nhật Bản. Thực ra, Trần Thị Thanh Thúy có thể đã góp mặt ở Nhật
                      Bản sớm hơn tuy nhiên do tình hình dịch bệnh Covid-19 phức tạp bùng phát tại TP. Hồ Chí Minh.</p>
                    <a href="#" class="aa-read-mor-btn">Đọc thêm<span class="fa fa-long-arrow-right"></span></a>
                  </div>
                </div>
              </div>
      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="aa-login-form">
            ...
            <label for="rememberme" class="rememberme"><input type="checkbox" id="rememberme"> Ghi nhớ tài khoản
            </label>
