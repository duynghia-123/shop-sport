                    ...
                    <div class="card mb-3">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9 text-secondary">
                            Nam <input type="radio" name="gioi_tinh" value="Nam" <?php if (isset($gioi_tinh) && $gioi_tinh == "Nam") {
                                                                                    echo "checked";
                                                                                  }  ?>>
                            Nữ <input type="radio" name="gioi_tinh" value="Nữ" <?php if (isset($gioi_tinh) && $gioi_tinh == "Nữ") {
                                                                                  echo "checked";
                                                                                } ?>>
                          </div>
                        </div>
